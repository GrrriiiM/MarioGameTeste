...
GameClient.start = function () {
    ...
    if (GameClient.offLine) {
        ...
        var player1 = new Person("player1", {
            top: 10,
            left: 1 * 32,
            direction: Direction.RIGHT,
            keyWalkRight: 68,
        ...
        this.ioSocket = io.connect('http://ultragrim:8080');
        ...
        $.ajax({
            url: "http://ultragrim:8080/remotegame/test",
            async: false,
            cache: false,
...
GameClient.animate = function () {
    ...
    if (GameClient.offLine) {
        ...
        $.ajax({
            url: "http://localhost:8080/remotegame/sync",
            async: false,
            data: params,
            dataType: "json",
            cache: false,
